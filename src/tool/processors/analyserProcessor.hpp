#ifndef _LOUDNESS_ASSESSMENT_TOOL_PROCESSORS_ANALYSER_PROCESSOR_HPP_
#define _LOUDNESS_ASSESSMENT_TOOL_PROCESSORS_ANALYSER_PROCESSOR_HPP_

#include <loudnessAnalyser/LoudnessAnalyser.hpp>
#include <tool/io/SoundFile.hpp>

void analyserProcessor( Loudness::LoudnessAnalyser& analyser, SoundFile& audioFile, void (*callback)(int) )
{
