...
struct LoudnessExport LoudnessLevels
{
    ...
    // custom levels
    LoudnessLevels(float ProgramLoudnessLongProgramMaxValue, float ProgramLoudnessLongProgramMinValue,
                   float ProgramLoudnessLongProgramTargetLevel, float ProgramLoudnessLongProgramTargetMaxLevel,
                   float ProgramLoudnessLongProgramTargetMinLevel, float ShortTermLoudnessLongProgramMaxValue,
                   float ShortTermLoudnessLongProgramMinValue, float ProgramLoudnessShortProgramMaxValue,
                   float ProgramLoudnessShortProgramMinValue, float ProgramLoudnessShortProgramTargetLevel,
                   float ProgramLoudnessShortProgramTargetMaxLevel, float ProgramLoudnessShortProgramTargetMinLevel,
                   float ShortTermLoudnessShortProgramMaxValue, float TruePeakMaxValue, float TruePeakTargetLevel,
                   float AbsoluteThresholdValue, float RelativeThresholdValue, float MaximalLoudnessRange,
                   float MinimalLoudnessRange, EStandard Standard = eStandardUnknown)
    ...
    {
        LoudnessLevels levels(-22.0,            // programLoudnessLongProgramMaxValue
