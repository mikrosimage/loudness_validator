...
void analyseFiles( Loudness::io::SoundFile* audioFile, size_t channels, Loudness::analyser::LoudnessAnalyser* ploudMeter, QProgressBar& progressBar, double gain = 1.0 )
{
