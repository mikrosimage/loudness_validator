...
Properties::Properties(QWidget* parent, Qt::WindowFlags f):
	...
	labelProgramLoudnessLongProgramTargetMaxLevel      ( tr( "<b><font color='blue'>target</font> <font color='red'>max</font></b> program loudness" ) ),
	labelProgramLoudnessLongProgramTargetMinLevel      ( tr( "<b><font color='blue'>target</font> <font color='green'>min</font></b> program loudness" ) ),
	...
	labelProgramLoudnessShortProgramTargetMaxLevel     ( tr( "<b><font color='blue'>target</font> <font color='red'>max</font></b> program loudness" ) ),
	labelProgramLoudnessShortProgramTargetMinLevel     ( tr( "<b><font color='blue'>target</font> <font color='green'>min</font></b> program loudness" ) ),
...
{
	programLoudnessLongProgramMaxValue       = spinProgramLoudnessLongProgramMaxValue.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessLongProgramMaxValue    .value();
	programLoudnessLongProgramMinValue       = spinProgramLoudnessLongProgramMinValue.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessLongProgramMinValue.value();
	programLoudnessLongProgramTargetLevel    = spinProgramLoudnessLongProgramTargetLevel.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessLongProgramTargetLevel.value();
	programLoudnessLongProgramTargetMinLevel = spinProgramLoudnessLongProgramTargetMinLevel.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessLongProgramTargetMinLevel.value();
	programLoudnessLongProgramTargetMaxLevel = spinProgramLoudnessLongProgramTargetMaxLevel.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessLongProgramTargetMaxLevel.value();
	
	shortTermLoudnessLongProgramMaxValue   = spinShortTermLoudnessLongProgramMaxValue.text().length() == 0 ? LOUDNESS_NAN : spinShortTermLoudnessLongProgramMaxValue.value();
	shortTermLoudnessLongProgramMinValue   = spinShortTermLoudnessLongProgramMinValue.text().length() == 0 ? LOUDNESS_NAN : spinShortTermLoudnessLongProgramMinValue.value();
	
	programLoudnessShortProgramMaxValue       = spinProgramLoudnessShortProgramMaxValue.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessShortProgramMaxValue.value();
	programLoudnessShortProgramMinValue       = spinProgramLoudnessShortProgramMinValue.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessShortProgramMinValue.value();
	programLoudnessShortProgramTargetLevel    = spinProgramLoudnessShortProgramTargetLevel.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessShortProgramTargetLevel.value();
	programLoudnessShortProgramTargetMinLevel = spinProgramLoudnessShortProgramTargetMinLevel.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessShortProgramTargetMinLevel.value();
	programLoudnessShortProgramTargetMaxLevel = spinProgramLoudnessShortProgramTargetMaxLevel.text().length() == 0 ? LOUDNESS_NAN : spinProgramLoudnessShortProgramTargetMaxLevel.value();
